        ...
        >
          <img
            ...
            style={{
              ...
              height: 28,
              borderRadius: 6,
              boxShadow: '0 0 12px rgba(147,73,204,0.5)',
            }}
          />
          <span
          ...
          >
            Legendary <span style={{ color: '#9349CC' }}>Mystic Forge</span>
          </span>
        </a>
        ...
        <div className="ml-auto flex items-center gap-2 shrink-0">
          ...
          <DropdownMenu>
            <DropdownMenuTrigger asChild>
              <Button variant="ghost" size="sm" className="gap-1.5" style={{ color: '#8e8a9a' }}>
          ...
          <Button
            ...
            onMouseLeave={(e) => ((e.currentTarget as HTMLButtonElement).style.color = '#8e8a9a')}
          >
