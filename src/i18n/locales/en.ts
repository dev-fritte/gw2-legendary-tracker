export default {
  ...
  characters: {
    ...
    onlyMaxLevel: 'Level 80 only',
    onlyMaxLevelHint: 'Select only level 80 characters',
    topN: 'Top N',
    topNHint: 'Select the N most-played characters by playtime',
    topNApply: 'Select',
    minPlaytimeLabel: 'Min. playtime',
    minPlaytimeApply: 'Select',
    minPlaytimeHint: 'Select all characters with at least {{hours}} h playtime',
  },
  overview: {
    stepLabel: 'OVERVIEW',
