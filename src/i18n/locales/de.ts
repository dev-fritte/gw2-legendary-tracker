export default {
  ...
  characters: {
    ...
    onlyMaxLevel: 'Nur Stufe 80',
    onlyMaxLevelHint: 'Nur Charaktere auf Stufe 80 auswählen',
    topN: 'Top N',
    topNHint: 'Die N meistgespielten Charaktere nach Spielzeit auswählen',
    topNApply: 'Auswählen',
    minPlaytimeLabel: 'Min. Spielzeit',
    minPlaytimeApply: 'Auswählen',
    minPlaytimeHint: 'Alle Charaktere mit mindestens {{hours}} h Spielzeit auswählen',
  },
  overview: {
    stepLabel: 'ÜBERSICHT',
